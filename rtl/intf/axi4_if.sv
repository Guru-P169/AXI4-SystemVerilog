interface axi4_if #(parameter int ADDR _WIDTH =32, parameter int DATA_WIDTH =32,parameter int ID_WIDTH = 4,parameter int USWE_WIDTH  =1,parameter  int REGION_WIDTH =4)
(
    input logic aclk,
    inputlogic  aresetn);
    ...
    modport monitor (
        ...
        input wid, wdata, wstrb, wlast, wuser, wvalid, wready,
